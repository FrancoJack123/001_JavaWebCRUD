...
function agregarProduct() {
    ...
    let cboCategoProductos = document.getElementById('cboAgregar').value;
...
function EditarProducto() {
    ...
    let cboCategoProductos = document.getElementById('cboEditar').value; // Obtén el valor
